 ...
 *
 * Язык один и он финский: платформа работает в Финляндии и для финнов.
 * Список остаётся списком — английский добавится тем же способом.
 */
export const locales = ['fi'] as const;
