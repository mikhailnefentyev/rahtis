...
/**
 * Язык по умолчанию для кода, которому локаль не досталась: ссылка из
 * письма без префикса, действие формы, маршрут отчёта.
 *
 * Финский, потому что рынок финский. Но живого посетителя без внятного
 * Accept-Language встречает не он, а английский — см. resolveLocale в
 * proxy.ts: в ту ветку попадают шведы, норвежцы и датчане, которым
 * финская страница бесполезна.
 */
