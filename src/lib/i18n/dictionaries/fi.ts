...
export const fi = {
  ...
  report_: {
    ...
    subVatNote: 'Kuukausimaksu on ilman alv:tä; alv 25,5 % sisältyy loppusummaan.',
    subVatNoteReverse: 'Alv 0 %: käännetty verovelvollisuus, ostaja tilittää veron omassa maassaan.',
    subNet: 'Kuukausimaksu ilman alv:tä',
    subPayable: 'Maksettava',
