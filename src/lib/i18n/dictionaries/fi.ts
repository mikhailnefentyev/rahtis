...
export const fi = {
  ...
  drivers: {
    ...
    inviteLink: 'Kutsulinkki on voimassa vuorokauden ja toimii kerran. Uusi linkki kirjaa vanhan puhelimen ulos.',
    copy: 'Kopioi',
    copied: 'Kopioitu',
  ...
  driverApp: {
    ...
    notLinkedHint: 'Pyydä kuljetusliikkeeltäsi kutsulinkki. Linkki on voimassa vuorokauden.',
  ...
  tes: {
    ...
    later: 'Arkipyhät, viikkoylityö ja vuorokausilepo lisätään myöhemmin.',
    save: 'Tallenna',
  ...
  msg: {
    ...
    'drivers.smsBody': 'RAHTIS-kuljettajasovellus: {link}',
  },
/*
