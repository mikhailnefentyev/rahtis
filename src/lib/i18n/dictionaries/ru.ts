...
export const ru = {
  ...
  landing: {
    eyebrow: 'Логистическая платформа · Финляндия',
    titleA: 'Машина не стоит.',
    titleB: 'Груз не ждёт.',
    lede:
      'Никто никому не звонит. Заказ сам уходит машинам нужного региона, отклики приходят за минуты, рейс ведётся по точкам и закрывается документами. Между сторонами стоит Aivomaa Oy и отвечает за результат.',
    asShipper: 'Я заказчик',
    asCarrier: 'Я перевозчик',
    signIn: 'Войти',
    apply: 'Подать заявку',
    moderationNote:
      'Открытой регистрации нет: каждая компания проверяется вручную по реестру PRH / YTJ.',
    fleetLabel: 'машин с допуском',
    fleetLive: 'обновляется при каждом допуске',
    clients: 'С кем работаем',

    /* Полоса фактов: не метрики, а правила — их можно проверить в первый день. */
    factDeadline: 'срок на каждое решение, дальше заказ уходит следующим',
    factOffers: 'выбираете вы, а не соглашаетесь на единственного',
    factDocs: 'в момент закрытия рейса, а не через неделю',

    cabinet: 'Кабинет',

    /* ── Что мы делаем ── */
    helpEyebrow: 'Что мы делаем',
    helpTitle: 'Помогаем грузам ехать, а машинам — не стоять',
    helpLede:
      'Aivomaa не заменяет ни вашего экспедитора, ни вашего водителя. Мы убираем то, что мешает им работать: поиск, согласование, объяснения по кругу и потерянные бумаги.',
    helpCargo: 'Грузу',
    helpCargoTitle: 'Уезжает в тот же день',
    helpCargoText:
      'Заказ уходит машинам нужного региона сразу после публикации. Пока вы заняты другим, отклики уже пришли.',
    helpTruck: 'Машине',
    helpTruckTitle: 'Не возвращается пустой',
    helpTruckText:
      'Стол заказов вашего региона открыт постоянно. Обратный рейс ищется там же, где вы отметили выгрузку.',
    helpDriver: 'Водителю',
    helpDriverTitle: 'Не звонит диспетчеру',
    helpDriverText:
      'Адрес, контакт на воротах, бронь и инструкции по точке лежат в самом рейсе. Остальное подскажет помощник в WhatsApp.',

    /* ── Время ── */
    timeEyebrow: 'Простой одинаково дорог обеим сторонам',
    timeTitle: 'Самое дорогое в логистике — это время',
    timeLede:
      'Пока заказчик обзванивает перевозчиков, груз стоит. Пока перевозчик обзванивает экспедиторов, стоит машина. Уходит одно и то же — часы, за которые никто никуда не доехал.',
    timeOld: 'Как это происходит обычно',
    timeOld1: 'Заказчик обзванивает знакомых, каждому объясняет груз заново',
    timeOld2: 'Перевозчик обзванивает экспедиторов, чтобы не гнать машину пустой',
    timeOld3: 'Договорились устно — через день неясно, кто что обещал',
    timeOld4: 'Водитель звонит диспетчеру за адресом, телефоном, временем ворот',
    timeOld5: 'Документы приходят через неделю, деньги выбиваются звонками',
    timeNew: 'Как в RAHTIS',
    timeNew1: 'Заказ публикуется один раз и уходит машинам нужного региона',
    timeNew2: 'Стол открыт всем допущенным машинам — искать не нужно никому',
    timeNew3: 'Условия записаны: ставка, точки, время, требования к машине',
    timeNew4: 'У водителя в заказе адрес, контакт, бронь и инструкции по точке',
    timeNew5: 'Документы прикладываются при закрытии, выплата — по недельному отчёту',

    /* ── Две двери ── */
    rolesEyebrow: 'Кому это нужно',
    rolesTitle: 'Две стороны, две разные задачи',
    shipperTitle: 'Не искать перевозчика — он найдётся сам',
    shipper1: 'Один раз опубликовали — заказ ушёл всем машинам региона забора',
    shipper2: 'До трёх откликов, выбираете по рейтингу перевозчика',
    shipper3: 'Маршрут можно править на ходу — водитель узнает об этом сам',
    shipper4: 'Документы приходят в момент закрытия рейса, не через неделю',
    shipper5: 'Отчёт по неделям: рейсы, суммы, документы, оценки',
    carrierTitle: 'Машина не простаивает между рейсами',
    carrier1: 'Стол заказов вашего региона открыт постоянно — обзванивать некого',
    carrier2: 'Обратный рейс ищется там же: пустой пробег tyhjäajo — это ваши деньги',
    carrier3: 'Допуск выдаётся по каждой машине отдельно',
    carrier4: 'Ставка, комиссия и сумма к выплате видны до того, как берёте',
    carrier5: 'Недельный отчёт: что заработано и когда придёт',

    /* ── Путь рейса ── */
    stepsEyebrow: 'Путь рейса',
    stepsTitle: 'От заявки до выплаты — четыре шага',
    step1: 'Проверка компании',
    step1Text: 'Y-tunnus сверяется с реестром, у перевозчика — лицензия и страховка.',
    step2: 'Допуск машин',
    step2Text: 'Оператор допускает каждую машину отдельно. Стол открывается только допущенным.',
    step3: 'Рейс по точкам',
    step3Text: 'Забор, загрузки и выгрузки отмечаются по порядку. Статус один на все три кабинета.',
    step4: 'Документы',
    step4Text:
      'Без rahtikirja рейс не закрывается. Накладная и фото приходят заказчику вместе с отметкой «выполнен».',

    /* ── Сбои ── */
    faultsEyebrow: 'Непрерывность',
    faultsTitle: 'Логистика ломается на мелочах. Мы их предусмотрели',
    faultsLede:
      'Бесперебойность — это не обещание, что ничего не случится, а описанное поведение, когда случается. Вот что происходит без единого звонка диспетчеру.',
    fault1: 'Водитель не подтвердил за 15 минут',
    fault1Text:
      'Заказ сам возвращается на стол и уходит следующим машинам. Срок — факт в базе, а не задание планировщика.',
    fault2: 'Порт перенёс окно, склад закрылся',
    fault2Text:
      'Заказчик правит точку прямо в идущем рейсе. Правка попадает в журнал, перевозчик видит пометку «Изменения от заказчика».',
    fault3: 'Прицеп поцарапали на заборе',
    fault3Text:
      'Повреждение пишется на конкретную точку с фото и временем — видно, на чьём плече это случилось.',
    fault4: 'Кто-то передумал до старта',
    fault4Text:
      'Откат возвращает заказ на стол, уведомления уходят всем. Рейс не зависает между сторонами.',

    /* ── Помощник водителя ── */
    aiEyebrow: 'Помощник водителя',
    aiSoon: 'Скоро',
    aiTitle: 'У водителя всегда есть, кого спросить',
    aiLede:
      'В WhatsApp у него открыт чат, который знает про этот рейс всё. Не бот с кнопками и не робот-автоответчик: он отвечает на языке, на котором водителю удобно.',
    aiOnline: 'WhatsApp · онлайн',
    ...
    ai1: 'Знает рейс наизусть',
    ai1Text: 'Адрес, контакт на воротах, бронь, номер прицепа — не нужно листать переписку.',
    ai2: 'Находит то, чего нет в заказе',
    ai2Text: 'Часы работы терминала, телефон склада, где купить ремни и уголки, где встать на паузу.',
    ai3: 'Считает время за рулём',
    ai3Text: 'Подскажет, успеваете ли до конца смены и когда пора на перерыв.',
    ai4: 'Отмечает точки за водителя',
    ai4Text: 'Написал «выгрузился» — статус увидели и заказчик, и перевозчик. Без звонка диспетчеру.',
    ai5: 'Зовёт человека, когда не уверен',
    ai5Text: 'Спорный случай уходит живому диспетчеру Aivomaa, а не остаётся без ответа.',
    ai6: 'Говорит на его языке',

    /* ── Направления ── */
    servicesEyebrow: 'Направления',
    servicesTitle: 'Начали с перецепа, идём к грузам',
    serviceLive: 'Работает',
    serviceSoon: 'Открываем',
    service1: 'Перецепка полуприцепов',
    service1Text:
      'Тягач забирает ваш прицеп в порту или на терминале, проходит загрузки и выгрузки, оставляет на площадке. Финляндия, дальше Скандинавия.',
    service2: 'Грузы со своим прицепом',
    service2Text:
      'Перевозчик приезжает со своей техникой: тент, рефрижератор, самосвал под сыпучие, трал под негабарит. Вы описываете вес и габариты — мы подбираем машину.',

    /* ── Финал и подвал ── */
    finalEyebrow: 'Начало работы',
    finalTitle: 'Расскажите о компании — остальное сделаем мы',
    finalLede:
      'Нужны название, Y-tunnus и почта. Мы проверим компанию по реестру и вышлем коды доступа. Перевозчику дополнительно понадобятся лицензия и страховка.',
  ...
  msg: {
    ...
    'landing.regions':
      '{count, plural, one {# регион} few {# региона} many {# регионов} other {# региона}}',
