...
export const en = {
  ...
  drivers: {
    ...
    inviteLink: 'The invite link is valid for 24 hours and works once. A new link signs the old phone out.',
    copy: 'Copy',
    copied: 'Copied',
  ...
  driverApp: {
    ...
    notLinkedHint: 'Ask your carrier for an invite link. The link is valid for 24 hours.',
  ...
  msg: {
    ...
    'drivers.smsBody': 'RAHTIS driver app: {link}',
  },
