...
export const en = {
  ...
  trip: {
    ...
    etaChange: 'Change estimate',
    etaSave: 'Save estimate',
    etaCancel: 'Cancel',
    etaInvalid: 'Check the time: the estimate can be at most a week ahead and not in the past.',
    etaLocked: 'An estimate can only be given for the next stop before arriving there.',
    etaSource: {
      ROUTE: 'by route',
      TRAFFIC: 'with traffic',
      CARRIER: 'reported by the carrier',
    },
  ...
  billingDesk: {
    ...
    subsColMonth: 'Month',
    subsColVehicles: 'Vehicles',
    subsColTotal: 'Incl. VAT',
    subsColDeducted: 'Deducted',
    subsColOpen: 'Open',
    subsPaid: 'Paid',
    subsMarkPaid: 'Payment received',
    subsUndo: 'Undo payment mark',
    subsNone: 'No monthly fees charged yet.',
    subsNoInvoice: 'Fully deducted',
  ...
  report_: {
    ...
    subColRef: 'Invoice',
    subColMonth: 'Month',
    subColDescription: 'Description',
    subColVehicles: 'Vehicles',
    subColUnit: 'Unit price',
    subDeducted: 'Deducted from the settlement',
    subEmailSubject: 'Invoice {number} · monthly fee {month}',
    subEmailLine: 'We invoice the monthly fee for the vehicles that drove during the month.',
    subVatNote: 'The monthly fee is excl. VAT; VAT 25.5 % is included in the total.',
    subVatNoteReverse: 'VAT 0 %: reverse charge, the buyer accounts for the tax in its own country.',
    subNet: 'Monthly fee excl. VAT',
    subPayable: 'To pay',
  ...
  pay: {
    ...
    tesGrade: 'Driver group',
    tesExperience: 'Driving experience since',
    tesExperienceHint:
      'The experience class (under 4, 4–8, 8–12, over 12 years) is counted from this date, and the pay rises by itself when the class changes.',
    tesSet: 'CBA rule set',
    save: 'Save model',
  ...
  msg: {
    ...
    'trip.enRouteEta': 'En route · {place} · ETA {time}',
    ...
    'billingDesk.week': 'wk {no}',
    'billingDesk.weekTrips': '{count, plural, one {wk {no}: # job} other {wk {no}: # jobs}}',
    'billingDesk.weekAmount': 'wk {no}: {amount}',
