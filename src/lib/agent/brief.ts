...
export function agentSystemPrompt(input: {
  ...
  if (admin) {
    lines.push(
      ...
      'Выручка оператора с 22.09.2026: плата заказчика 3 % сверху цены за заказ со стола (orders.shipper_fee_bps, прямые заказы — 0) и месячный сбор перевозчика 29,90 € + ALV за машину, закрывшую рейс в месяце (carrier_subscription_fees, удержания — carrier_fee_deductions). Процента с перевозчика больше нет: commission_bps в новых рейсах 0. Оборот, выручка и выплаты — разные числа, не путай их.',
