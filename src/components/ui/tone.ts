 ...
 * правило «акцент только для интерактива, семантика только для
 * состояния» держится почти само собой: у Button нет тона live, у Badge
 * нет заливки акцентом.
 *
 * Почти — потому что info ниже собран из акцента. Это единственное
 * место, где цвет интерактива попадает на состояние; подробности в
 * комментарии к Badge.
 */
