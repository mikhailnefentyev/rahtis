 ...
 *
 * Здесь всё, что нужно, когда заказ уже нашли: отклики, этап, маршрут,
 * карта, правки, снятие. Раньше это рисовалось сразу для каждого заказа
 * в списке — при тридцати активных единицах на странице оказывалось
 * тридцать карт, и найти среди них нужную было нельзя.
 *
 * Теперь карточку раскрывают по одной. Список остаётся списком.
 */
