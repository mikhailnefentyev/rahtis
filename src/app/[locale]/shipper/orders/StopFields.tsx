  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2">
      ...
      <div className="grid grid-cols-2 gap-3">
        {/*
          * Поле даты нативное намеренно.
          *
          * Chrome рисует его заполнитель и календарь на языке своего
          * интерфейса и атрибут lang игнорирует — проверено на трёх полях
          * с разным lang, вид одинаковый. Значит у русского браузера здесь
          * будет «дд.мм.гггг», и никакой правкой разметки это не меняется.
          *
          * Своё поле с календарём это убрало бы, но ценой худшего: пропал
          * бы нативный выбор даты на телефоне, а финский диспетчер стал бы
          * читать наш формат вместо привычного pp.kk.vvvv. Значение всё
          * равно уходит в ISO независимо от вида, так что данным ничего не
          * грозит.
          */}
